...
import base64
import zlib
import solitudeCode.blackboxprotobuf.burp
import solitudeCode.blackboxprotobuf
from javax.swing import JSplitPane, JPanel, JButton, BoxLayout, JOptionPane
from java.awt import Component
from java.awt.event import ActionListener
from solitudeCode.blackboxprotobuf.burp import user_funcs
from solitudeCode.blackboxprotobuf.burp import typedef_editor

class ProtoBufEditorTabFactory(solitudeCode.blackboxprotobuf.burp.IMessageEditorTabFactory):
...
class ProtoBufEditorTab(solitudeCode.blackboxprotobuf.burp.IMessageEditorTab):
    ...
    def getMessage(self):
        ...
        try:
            ...
            protobuf_data = solitudeCode.blackboxprotobuf.protobuf_from_json(json_data, self.message_type)
    ...
    def setMessage(self, content, is_request, retry=True):
        ...
        try:
            ...
            json_data, self.message_type = solitudeCode.blackboxprotobuf.protobuf_to_json(
    ...
    def saveTypeMenu(self):
        ...
        solitudeCode.blackboxprotobuf.known_messages[selection] = self.message_type
